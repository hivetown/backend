...
export class Migration20230515092630 extends Migration {
	async up(): Promise<void> {
		...
		this.addSql(
			'create table `producer` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `email` varchar(255) not null, `phone` varchar(255) not null, `vat` varchar(255) not null, `auth_id` varchar(255) not null, `image_id` int unsigned null, `deleted_at` datetime null) default character set utf8mb4 engine = InnoDB;'
		);
		...
		this.addSql(
			'create table `consumer` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null, `email` varchar(255) not null, `phone` varchar(255) not null, `vat` varchar(255) not null, `auth_id` varchar(255) not null, `image_id` int unsigned null, `deleted_at` datetime null) default character set utf8mb4 engine = InnoDB;'
		);
