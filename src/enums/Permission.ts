...
export enum Permission {
	...
	// Notifications
	ALL_NOTIFICATION = 0b111000000000000, // helper for all notification permissions
	READ_OTHER_NOTIFICATION = 0b1000000000000,
	WRITE_OTHER_NOTIFICATION = 0b10000000000000,
	DELETE_OTHER_NOTIFICATION = 0b100000000000000,

	// ALL
	ALL = ALL_ADMIN | ALL_CATEGORY | ALL_CONSUMER | ALL_PRODUCER | ALL_PRODUCT | ALL_NOTIFICATION
}
