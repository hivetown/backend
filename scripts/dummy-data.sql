...
insert into hivetown.producer (id, name, email, phone, vat) values (1, 'Johannes Russi', 'jrussi0@youtu.be', 996749169, 766910242);
insert into hivetown.producer (id, name, email, phone, vat) values (2, 'Nettle Paddick', 'npaddick1@wiley.com', 976491619, 660226755);
insert into hivetown.producer (id, name, email, phone, vat) values (3, 'Jillian Sherwin', 'jsherwin2@xinhuanet.com', 930576656, 370332941);
insert into hivetown.producer (id, name, email, phone, vat) values (4, 'Tabbi Inglese', 'tinglese3@stumbleupon.com', 932246604, 961235560);
insert into hivetown.producer (id, name, email, phone, vat) values (5, 'Mychal Claypool', 'mclaypool4@nasa.gov', 932729562, 680435535);
insert into hivetown.producer (id, name, email, phone, vat) values (6, 'Jess Bigby', 'jbigby5@sakura.ne.jp', 925757259, 585069677);
insert into hivetown.producer (id, name, email, phone, vat) values (7, 'Lexie Woolhouse', 'lwoolhouse6@mozilla.org', 964142495, 486629358);
insert into hivetown.producer (id, name, email, phone, vat) values (8, 'Orlando Apfel', 'oapfel7@homestead.com', 912909808, 389611952);
insert into hivetown.producer (id, name, email, phone, vat) values (9, 'Angela Manicom', 'amanicom8@ucoz.com', 917812435, 624460208);
insert into hivetown.producer (id, name, email, phone, vat) values (10, 'Justinian Clemencon', 'jclemencon9@tripadvisor.com', 923500321, 683211353);
...
insert into hivetown.product_spec_category (product_spec_id, category_id) values (1, 3);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (1, 6);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (2, 1);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (2, 4);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (3, 2);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (3, 5);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (4, 2);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (4, 8);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (5, 3);
insert into hivetown.product_spec_category (product_spec_id, category_id) values (5, 7);

-- product_spec_field

insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (4, 1, 8, "Branco");
insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (4, 2, 8, "40");
insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (4, 3, 8, "NOVO");
insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (2,1,1,"Preto");
insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (2,2,1,"32");
insert into hivetown.product_spec_field (product_spec_category_product_spec_id, field_id, product_spec_category_category_id, value) values (2,3,1,"USADO");
